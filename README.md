...
| Step | 산출물 |
|------|--------|
| Step 1 | call graph, data/control flow, guard/enforcement 관계, trust boundary, config/mode/command trigger, callback registration, evidence anchor |
| Step 2 | verified entrypoints (substrate에 누적) |
